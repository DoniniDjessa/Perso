        ...
        >
          ...
          <YStack flex={1} justifyContent="center" padding={28} gap={28}>
            <YStack alignItems="center" gap={12}>
              <LogoMark size={96} />
              <Text style={{ ...fonts.extra, fontSize: 34, color: colors.black, letterSpacing: -0.6 }}>
                Perso
              </Text>
            ...
            <YStack gap={16}>
              ...
              <Field
                ...
                right={
                  <Pressable onPress={() => setShowPassword((v) => !v)} style={{ paddingRight: 16 }}>
                    {showPassword ? (
                      <EyeOff size={18} color={colors.indigo} />
                    ) : (
              ...
              <YStack marginTop={8}>
                <PrimaryButton
                  label={mode === 'in' ? 'Se connecter' : 'Créer mon compte'}
                  onPress={submit}
                  loading={busy}
              ...
              >
                <Text
                  textAlign="center"
                  style={{ ...fonts.semibold, color: colors.violet, fontSize: 14 }}
                >
