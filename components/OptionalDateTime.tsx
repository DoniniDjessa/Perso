...
export function OptionalDateTime({
  ...
  emptyDate = 'Auto · aujourd’hui',
  emptyTime = 'Auto · maintenant',
}: {
  date: Date | null
  time: Date | null
...
export function resolveSpentAt(date: Date | null, time: Date | null) {
...
export function resolveOptionalAt(date: Date | null, time: Date | null) {
  if (!date && !time) return null
  return resolveSpentAt(date, time)
}
